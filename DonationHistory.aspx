<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonationHistory.aspx.cs" Inherits="ClinicalBloodBank.DonationHistory" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Clinical Blood Bank - Donation History</title>
    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="DonationHistory.aspx" class="menu-item active">
        ...
        <div class="main-content">
            ...
            <div class="dashboard-cards">
                ...
                <div class="card">
                    ...
                    <div class="card-value">
                        <asp:Literal ID="litLastDonation" runat="server" Text="Never"></asp:Literal>
                    </div>
                    <div class="card-label">Most Recent Donation</div>
                </div>
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Total Blood Donated</div>
                        <div class="card-icon">🩸</div>
                    </div>
                    <div class="card-value">
                        <asp:Literal ID="litTotalBlood" runat="server" Text="0"></asp:Literal> ml
                    </div>
                    <div class="card-label">Total Volume Donated</div>
                </div>
                <div class="card">
                    <div class="card-header">
            ...
            <div class="content-section">
                ...
                <div class="filter-container">
                    <div class="filter-group">
                        ...
                        <asp:DropDownList ID="ddlStatusFilter" runat="server" CssClass="filter-select" AutoPostBack="true" OnSelectedIndexChanged="FilterChanged">
                    ...
                    <div class="filter-group">
                        ...
                        <asp:DropDownList ID="ddlSortBy" runat="server" CssClass="filter-select" AutoPostBack="true" OnSelectedIndexChanged="FilterChanged">
                            <asp:ListItem Value="donation_date DESC">Newest First</asp:ListItem>
                            <asp:ListItem Value="donation_date ASC">Oldest First</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                ...
                <asp:Repeater ID="rptDonations" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><span class='status-badge status-<%# Eval("test_result") %>'><%# Eval("test_result") %></span></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                        </table>
                ...
                <div class="pagination" id="paginationContainer" runat="server" visible="false">
                    <asp:LinkButton ID="btnPrev" runat="server" CssClass="pagination-btn" OnClick="btnPrev_Click">&laquo; Previous</asp:LinkButton>
                    <asp:Label ID="lblPageInfo" runat="server" CssClass="pagination-btn" style="background-color: transparent; border: none;"></asp:Label>
                    <asp:LinkButton ID="btnNext" runat="server" CssClass="pagination-btn" OnClick="btnNext_Click">Next &raquo;</asp:LinkButton>
                </div>
            </div>
        </div>
