    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="ManageAppointments.aspx" class="menu-item active">
            ...
            <div class="content-section">
                ...
                <asp:GridView ID="gvAppointments" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="appointment_id"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="appointment_date" HeaderText="Date & Time" DataFormatString="{0:g}" />
