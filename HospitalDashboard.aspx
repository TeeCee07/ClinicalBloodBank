...
<head runat="server">
    <title>Clinical Blood Bank - Hospital Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="main-content">
            ...
            <div class="dashboard-cards">
                ...
                <div class="card">
                    ...
                    <div class="card-value">
                        <asp:Literal ID="litUpcomingAppointments" runat="server" Text="0"></asp:Literal>
                    </div>
                    <div class="card-label">Scheduled Donations</div>
                </div>
            </div>
