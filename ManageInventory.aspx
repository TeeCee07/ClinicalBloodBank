    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="ManageInventory.aspx" class="menu-item active">
        ...
        <div class="main-content">
            ...
            <div class="content-section">
                ...
                <div class="form-group">
                    <label for="ddlInventoryBloodType">Blood Type</label>
                ...
                <div class="form-group">
                    <label for="txtQuantity">Quantity (ml)</label>
                    <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control" TextMode="Number" />
                </div>
                <div class="form-group">
                    <label for="txtDonationDate">Donation Date</label>
                ...
                <div class="form-group">
                    <label for="ddlHospital">Tested By Hospital</label>
                    <asp:DropDownList ID="ddlHospital" runat="server" CssClass="form-control" />
                </div>
                <div class="form-group">
                    <label for="ddlTestResult">Test Result</label>
            ...
            <div class="content-section">
                ...
                <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="inventory_id"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="donation_date" HeaderText="Donation Date" DataFormatString="{0:d}" />
                        <asp:BoundField DataField="expiration_date" HeaderText="Expiration Date" DataFormatString="{0:d}" />
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <div class="action-buttons">
                                    ...
                                    <asp:Button ID="btnDelete" runat="server" CommandName="Delete" Text="Delete" CssClass="btn btn-sm btn-delete" OnClientClick="return confirm('Are you sure you want to delete this inventory item?');" />
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
