<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonorProfile.aspx.cs" Inherits="ClinicalBloodBank.DonorProfile" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Clinical Blood Bank - My Profile</title>
    <style>
...
<body>
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="DonorProfile.aspx" class="menu-item active">
    ...
    <span class="menu-icon">🚪</span> Logout
        ...
        <div class="main-content">
                    ...
                    <div class="user-profile">
                        ...
                        <div class="profile-dropdown" id="profileDropdown">
                            <a href="DonorProfile.aspx" class="profile-dropdown-item">Profile</a>
                                        <asp:LinkButton ID="LinkButton1" runat="server" CssClass="menu-item" OnClick="lnkLogout_Click">
              <span class="menu-icon">🚪</span> Logout
             </asp:LinkButton>
                        </div>
                    </div>
            ...
            <div class="success-message" id="successMessage" runat="server"></div>
            ...
            <div class="content-section">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtWeight" runat="server" CssClass="form-control" TextMode="Number" step="0.1" min="0" required></asp:TextBox>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-label">Health Conditions</label>
                    <asp:TextBox ID="txtHealthConditions" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtAddressLine1" runat="server" CssClass="form-control" MaxLength="255"></asp:TextBox>
                </div>
                <div class="form-group">
                    <label class="form-label">Address Line 2</label>
                    <asp:TextBox ID="txtAddressLine2" runat="server" CssClass="form-control" MaxLength="255"></asp:TextBox>
                </div>
                <div class="form-row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtProvince" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtCountry" runat="server" CssClass="form-control" MaxLength="100" Text="South Africa"></asp:TextBox>
                    </div>
                </div>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtNewPassword" runat="server" CssClass="form-control" TextMode="Password" placeholder="Leave blank to keep current password"></asp:TextBox>
                    </div>
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <a href="DonorDashboard.aspx" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
