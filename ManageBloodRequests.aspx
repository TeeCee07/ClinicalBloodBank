    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="content-section">
                ...
                <div class="form-group">
                    <label for="ddlRequestStatus">Status</label>
                ...
                <div class="form-group">
                    <label for="ddlFulfillHospital">Fulfilled By Hospital</label>
            ...
            <div class="content-section">
                ...
                <asp:GridView ID="gvBloodRequests" runat="server" AutoGenerateColumns="False" CssClass="table" DataKeyNames="request_id"
                    OnRowEditing="gvBloodRequests_RowEditing">
                    <Columns>
                        ...
                        <asp:BoundField DataField="requested_at" HeaderText="Requested At" DataFormatString="{0:g}" />
